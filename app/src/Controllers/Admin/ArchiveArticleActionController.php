...
class ArchiveArticleActionController extends AbstractController
{
    public function process(Request $request): Response
    {
        ...
        // Les auteurs ne peuvent archiver que leurs articles
        ...
        return Response::redirect('/admin/articles?success=archived');
    }
}
